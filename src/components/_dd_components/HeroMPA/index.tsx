...
import heroConfig from '@/config/heroConfigMPA.json';
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="p-2 bg-white dark:bg-gray-800 shadow rounded-lg flex items-center space-x-4 max-w-xs">
                  ...
                  <img
                    src="/images/testimonials/Angelika.jpg"

                    alt="Angelika Bergmann"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="space-y-6 pt-3">
                ...
                <div className="p-2 bg-white dark:bg-gray-800 shadow rounded-lg flex items-center space-x-4 max-w-xs">
                  ...
                  <img
                    src="/images/testimonials/DrEckardt-min.jpg"
                    alt="Praxisinhaber, Zürich"
                    className="w-12 h-12 rounded-full object-cover"
                  />
                  <div>
                    <p className="text-xs text-gray-700 dark:text-gray-300">
